...
public class InlineKeyBoardUtil {
    ...
    public static InlineKeyboardMarkup specialtyButtons() {
        return InlineKeyboardButtonUtil.keyboard(InlineKeyboardButtonUtil.collection(
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Ta'lim", "Ta'lim")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Chet tili", "Chet tili")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("IT", "IT")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Management", "Management")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Media va dizayn", "Media va dizayn")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Iqtisodiyot", "Iqtisodiyot"))));
    }
    ...
    public static InlineKeyboardMarkup educateButtons() {
        return InlineKeyboardButtonUtil.keyboard(InlineKeyboardButtonUtil.collection(
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Matematika", "Matematika")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Biologiya", "Biologiya")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Kimyo", "Kimyo")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Fizika", "Fizika")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Huquq", "Huquq")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Tarix", "Tarix")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Ona-tili", "Ona-tili")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Mental Arifmetika", "Mental Arifmetika")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Maktabgacha tayyorlov", "Maktabgacha tayyorlov")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Logoped", "Logoped")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("IT trainer", "IT trainer"))
        ));
    }

    public static InlineKeyboardMarkup foreignLanguageButtons() {
        return InlineKeyboardButtonUtil.keyboard(InlineKeyboardButtonUtil.collection(
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Ingliz tili", "Ingliz tili")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Arab tili", "Arab tili")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Koreys tili", "Koreys tili")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Rus tili", "Rus tili")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("IELTS", "IELTS")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("CEFR", "CEFR")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("GMAT", "GMAT")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("SAT", "SAT"))));
    }

    public static InlineKeyboardMarkup ITButtons() {
        return InlineKeyboardButtonUtil.keyboard(InlineKeyboardButtonUtil.collection(
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Full-Stack developer", "Full-Stack developer")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Frontend developer", "Frontend developer")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Backend developer", "Backend developer")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Mobile developer", "Mobile developer")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("(QA) Engineer", "(QA) Engineer")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("(AI) Engineer", "(AI) Engineer")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Data scientist", "Data scientist")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Data analyst", "Data analyst")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Security analyst", "Security analyst")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("System adminstrator", "System adminstrator")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Network adminstrator", "Network adminstrator")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("IT trainer", "IT trainer"))
        ));
    }
    ...
    public static InlineKeyboardMarkup mediaAndDesignButtons() {
        return InlineKeyboardButtonUtil.keyboard(InlineKeyboardButtonUtil.collection(
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("SMM", "SMM")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Graphic designer", "Graphic designer")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("UI/UX designer", "UI/UX designer")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Content creator", "Content creator")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Mobilograph", "Mobilograph")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Videographer", "Videographer")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Video editor", "Video editor")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Copywriter", "Copywriter"))
        ));
    }

    public static InlineKeyboardMarkup managementButtons() {
        return InlineKeyboardButtonUtil.keyboard(InlineKeyboardButtonUtil.collection(
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Project manager", "Project manager")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Sales manager", "Sales manager")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Marketolog", "Marketolog")),
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("HR manager", "HR manager"))
        ));
    }

    public static InlineKeyboardMarkup economicsButtons() {
        return InlineKeyboardButtonUtil.keyboard(InlineKeyboardButtonUtil.collection(
                InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("Bugalter", "Bugalter"))));
    }
    ...
    public static InlineKeyboardMarkup editingVacancyButtons() {
        return InlineKeyboardButtonUtil.keyboard(
                InlineKeyboardButtonUtil.collection(
                        InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("\uD83C\uDFE2 Ish beruvchi", "employerName")),
                        InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("\uD83D\uDDFA Manzil", "address")),
                        InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("\uD83D\uDCCB Yo'nalish", "specialty")),
                        InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("\uD83D\uDC68\uD83C\uDFFB\u200D\uD83D\uDCBC Lavozim", "position")),
                        InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("\uD83D\uDCB0 Maosh", "salary")),
                        InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("\uD83D\uDD5E Haftalik ish soati", "workTime")),
                        InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("\uD83D\uDCF1 Aloqa", "callAddress")),
                        InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("‼\uFE0F Qo'shimcha", "extraInfo"))));
    ...
    public static InlineKeyboardMarkup editingResumeButtons() {
        return InlineKeyboardButtonUtil.keyboard(
                InlineKeyboardButtonUtil.collection(
                        InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("\uD83D\uDC68\uD83C\uDFFB\u200D\uD83D\uDCBC\uD83D\uDC69\uD83C\uDFFB\u200D\uD83D\uDCBC Ism", "employeeName")),
                        InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("\uD83D\uDDFA Manzil", "address")),
                        InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("\uD83D\uDCCB Yo'nalish", "specialty")),
                        InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("❇\uFE0F Texnologiya va kasbiy ko'nikmalar", "technologies")),
                        InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("\uD83D\uDCB0 Maosh", "salary")),
                        InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("\uD83D\uDD5E Haftalik ish soati", "workTime")),
                        InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("\uD83D\uDCF1 Aloqa", "callAddress")),
                        InlineKeyboardButtonUtil.row(InlineKeyboardButtonUtil.button("‼\uFE0F Qo'shimcha", "extraInfo"))));
